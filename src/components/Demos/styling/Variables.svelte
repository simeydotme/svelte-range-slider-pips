...
<div class="variables">
  ...
  <div class="inputs">
    ...
    <input
      type="color"
      name="clrHandleInactive"
      id="clrHandleInactive"
      bind:value={clrHandleInactive}
      title="--range-handle-inactive"
    />
    ...
    <input
      ...
      name="clrHandleFocus"
      id="clrHandleFocus"
      bind:value={clrHandleFocus}
      title="--range-handle-focus"
    />
    <input
      type="color"
      name="clrHandleBorder"
      id="clrHandleBorder"
      bind:value={clrHandleBorder}
      title="--range-handle-border"
    />
  </div>
  ...
  <div class="inputs">
    ...
    <input
      type="color"
      name="clrFloatInactive"
      id="clrFloatInactive"
      bind:value={clrFloatInactive}
      title="--range-float-inactive"
    />
  ...
  <div class="inputs">
    ...
    <input
      type="color"
      name="clrPipActiveText"
      id="clrPipActiveText"
      bind:value={clrPipActiveText}
      title="--range-pip-active-text"
    />
    <input type="color" name="clrPipHover" id="clrPipHover" bind:value={clrPipHover} title="--range-pip-hover" />
    <input
      type="color"
      name="clrPipHoverText"
      id="clrPipHoverText"
      bind:value={clrPipHoverText}
      title="--range-pip-hover-text"
    />
  </div>
  ...
  <div class="inputs">
    ...
    <input
      ...
      name="clrPipInRange"
      id="clrPipInRange"
      bind:value={clrPipInRange}
      title="--range-pip-in-range"
    />
    <input
      type="color"
      name="clrPipInRangeText"
      id="clrPipInRangeText"
      bind:value={clrPipInRangeText}
      title="--range-pip-in-range-text"
    />
  </div>
