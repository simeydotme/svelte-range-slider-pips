...
export const colorsPartsStore = createPersistedStore('svelte-range-slider-colors-parts', defaultColorsParts);
export const selectedPresetStore = persisted('svelte-range-slider-selected-preset', 'Default');

export const lightThemeColors = derived(colorsStore, store => (
...
export const darkThemeColors = derived(colorsStore, store => (
