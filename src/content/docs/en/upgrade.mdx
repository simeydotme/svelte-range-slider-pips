...
- **Default (Light mode):**
  ...
  ```
  <Info>This is the same as v3.</Info>
...
- **Automatic (system preference):**
  ...
  ```
  <Info>This is the best option if your website has a dark mode toggle.</Info>
...
- **Force Dark Mode:**
  ...
  regardless of system settings. -->
  ```
  <Info>This is the best option if your website is just dark.</Info>
