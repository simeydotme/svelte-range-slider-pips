...
image:
  src: '/svelte-range-slider-pips/recipes/liquid-glass.png'
  alt: 'Liquid Glass Slider recipe'
---
...
Well, it's 2025 and Apple have seemingly decided to abandon accessible UI in favor
