...
(function (global, factory) {
	...
	function add_css(target) {
		append_styles(target, "svelte-1q1rqyo", ".rangeSlider{--slider:var(--range-slider, #d7dada);--handle-inactive:var(--range-handle-inactive, #99a2a2);--handle:var(--range-handle, #838de7);--handle-focus:var(--range-handle-focus, #4a40d4);--handle-border:var(--range-handle-border, var(--handle));--range-inactive:var(--range-range-inactive, var(--handle-inactive));--range:var(--range-range, var(--handle-focus));--range-limit:var(--range-range-limit, #b9c2c2);--range-hover:var(--range-range-hover, var(--handle-border));--range-press:var(--range-range-press, var(--handle-border));--float-inactive:var(--range-float-inactive, var(--handle-inactive));--float:var(--range-float, var(--handle-focus));--float-text:var(--range-float-text, white)}.rangeSlider{position:relative;border-radius:100px;height:0.5em;margin:1em;transition:opacity 0.2s ease;user-select:none}.rangeSlider *{user-select:none}.rangeSlider.pips{margin-bottom:1.8em}.rangeSlider.pip-labels{margin-bottom:2.8em}.rangeSlider.vertical{display:inline-block;border-radius:100px;width:0.5em;min-height:200px}.rangeSlider.vertical.pips{margin-right:1.8em;margin-bottom:1em}.rangeSlider.vertical.pip-labels{margin-right:2.8em;margin-bottom:1em}.rangeSlider .rangeHandle{position:absolute;display:block;height:1.4em;width:1.4em;top:0.25em;bottom:auto;transform:translateY(-50%) translateX(-50%);z-index:2}.rangeSlider.reversed .rangeHandle{transform:translateY(-50%) translateX(50%)}.rangeSlider.vertical .rangeHandle{left:0.25em;top:auto;transform:translateY(50%) translateX(-50%)}.rangeSlider.vertical.reversed .rangeHandle{transform:translateY(-50%) translateX(-50%)}.rangeSlider .rangeNub,.rangeSlider .rangeHandle:before{position:absolute;left:0;top:0;display:block;border-radius:10em;height:100%;width:100%;transition:box-shadow 0.2s ease}.rangeSlider .rangeHandle:before{content:'';left:1px;top:1px;bottom:1px;right:1px;height:auto;width:auto;box-shadow:0 0 0 0px var(--handle-border);opacity:0}.rangeSlider.hoverable:not(.disabled) .rangeHandle:hover:before{box-shadow:0 0 0 8px var(--handle-border);opacity:0.2}.rangeSlider.hoverable:not(.disabled) .rangeHandle.press:before,.rangeSlider.hoverable:not(.disabled) .rangeHandle.press:hover:before{box-shadow:0 0 0 12px var(--handle-border);opacity:0.4}.rangeSlider.range:not(.min):not(.max) .rangeNub{border-radius:10em 10em 10em 1.6em}.rangeSlider.range .rangeHandle:nth-of-type(1) .rangeNub{transform:rotate(-135deg)}.rangeSlider.range .rangeHandle:nth-of-type(2) .rangeNub{transform:rotate(45deg)}.rangeSlider.range.reversed .rangeHandle:nth-of-type(1) .rangeNub{transform:rotate(45deg)}.rangeSlider.range.reversed .rangeHandle:nth-of-type(2) .rangeNub{transform:rotate(-135deg)}.rangeSlider.range.vertical .rangeHandle:nth-of-type(1) .rangeNub{transform:rotate(135deg)}.rangeSlider.range.vertical .rangeHandle:nth-of-type(2) .rangeNub{transform:rotate(-45deg)}.rangeSlider.range.vertical.reversed .rangeHandle:nth-of-type(1) .rangeNub{transform:rotate(-45deg)}.rangeSlider.range.vertical.reversed .rangeHandle:nth-of-type(2) .rangeNub{transform:rotate(135deg)}.rangeSlider .rangeFloat{display:block;position:absolute;left:50%;bottom:1.75em;transform:translate(-50%, -50%);font-size:1em;text-align:center;opacity:0;pointer-events:none;white-space:nowrap;transition:all 0.2s ease;font-size:0.9em;padding:0.2em 0.4em;border-radius:0.2em;z-index:3}.rangeSlider .rangeHandle.active .rangeFloat,.rangeSlider.hoverable .rangeHandle:hover .rangeFloat,.rangeSlider.hoverable .rangeBar:hover .rangeFloat,.rangeSlider.focus .rangeBar .rangeFloat{opacity:1;transform:translate(-50%, 0%)}.rangeSlider .rangeBar .rangeFloat{bottom:0.875em;z-index:2}.rangeSlider.vertical .rangeFloat{top:50%;bottom:auto;left:auto;right:1.75em;transform:translate(-50%, -50%)}.rangeSlider.vertical .rangeHandle.active .rangeFloat,.rangeSlider.vertical.hoverable .rangeHandle:hover .rangeFloat,.rangeSlider.vertical.hoverable .rangeBar:hover .rangeFloat,.rangeSlider.vertical.focus .rangeBar .rangeFloat{transform:translate(0%, -50%)}.rangeSlider.vertical .rangeBar .rangeFloat{right:0.875em}.rangeSlider .rangeBar,.rangeSlider .rangeBar.rangeDrag::before,.rangeSlider .rangeLimit{position:absolute;display:block;transition:background 0.2s ease;border-radius:1em;height:0.5em;top:0;user-select:none;z-index:1}.rangeSlider.vertical .rangeBar,.rangeSlider.vertical .rangeBar.rangeDrag::before,.rangeSlider.vertical .rangeLimit{width:0.5em;height:auto}.rangeSlider .rangeBar.rangeDrag::before{content:'';inset:0;top:-0.5em;bottom:-0.5em;height:auto;background-color:var(--range-hover);opacity:0;transition:opacity 0.2s ease,\n      scale 0.2s ease}.rangeSlider.vertical .rangeBar.rangeDrag::before{inset:0;left:-0.5em;right:-0.5em;width:auto}.rangeSlider.hoverable:not(.disabled) .rangeDrag:hover::before{opacity:0.2}.rangeSlider.hoverable:not(.disabled) .rangeDrag.press::before{opacity:0.4;scale:1 1.25}.rangeSlider.vertical.hoverable:not(.disabled) .rangeDrag.press::before{scale:1.25 1}.rangeSlider{background-color:#d7dada;background-color:var(--slider)}.rangeSlider .rangeBar{background-color:#99a2a2;background-color:var(--range-inactive)}.rangeSlider.focus .rangeBar{background-color:#838de7;background-color:var(--range)}.rangeSlider .rangeLimit{background-color:#99a2a280;background-color:var(--range-limit)}.rangeSlider .rangeNub{background-color:#99a2a2;background-color:var(--handle-inactive)}.rangeSlider.focus .rangeNub{background-color:#838de7;background-color:var(--handle)}.rangeSlider .rangeHandle.active .rangeNub{background-color:#4a40d4;background-color:var(--handle-focus)}.rangeSlider .rangeFloat{color:white;color:var(--float-text);background-color:#99a2a2;background-color:var(--float-inactive)}.rangeSlider.focus .rangeFloat{background-color:#4a40d4;background-color:var(--float)}.rangeSlider.disabled{opacity:0.5}.rangeSlider.disabled .rangeNub{background-color:#d7dada;background-color:var(--slider)}");
	}
	...
	// (730:2) {#each values as value, index}
	function create_each_block(ctx) {
		...
		return {
			c() {
				...
				toggle_class(span1, "active", /*focus*/ ctx[31] && /*activeHandle*/ ctx[34] === /*index*/ ctx[89]);
				toggle_class(span1, "press", /*handlePressed*/ ctx[32] && /*activeHandle*/ ctx[34] === /*index*/ ctx[89]);
			},
			m(target, anchor) {
	...
	function create_if_block_1(ctx) {
		...
		return {
			c() {
				...
				toggle_class(span, "rangeDrag", /*draggy*/ ctx[10]);
				toggle_class(span, "press", /*rangePressed*/ ctx[33]);
				toggle_class(span, "range", /*range*/ ctx[9]);
			},
			m(target, anchor) {
				insert(target, span, anchor);
				if (if_block) if_block.m(span, null);
	...
	function create_fragment(ctx) {
		...
		return {
			c() {
				...
				toggle_class(div, "min", /*range*/ ctx[9] === 'min');
				toggle_class(div, "max", /*range*/ ctx[9] === 'max');
				toggle_class(div, "disabled", /*disabled*/ ctx[17]);
				toggle_class(div, "hoverable", /*hoverable*/ ctx[16]);
				toggle_class(div, "vertical", /*vertical*/ ctx[12]);
				toggle_class(div, "reversed", /*reversed*/ ctx[15]);
				toggle_class(div, "focus", /*focus*/ ctx[31]);
				toggle_class(div, "pips", /*pips*/ ctx[19]);
				toggle_class(div, "pip-labels", /*all*/ ctx[21] === 'label' || /*first*/ ctx[29] === 'label' || /*last*/ ctx[22] === 'label' || /*rest*/ ctx[23] === 'label');
			},
			m(target, anchor) {
				insert(target, div, anchor);
			...
			p(ctx, dirty) {
				...
				if (!current || dirty[0] & /*classes, range*/ 268435968) {
					toggle_class(div, "min", /*range*/ ctx[9] === 'min');
				}
