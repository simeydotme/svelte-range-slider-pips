			...
			if ($$self.$$.dirty[0] & /*values, min, max, step, precision, limits, springPositions*/ 536937031 | $$self.$$.dirty[1] & /*valueLength, springValues*/ 25165824) {
				{
					...
					$$invalidate(55, valueLength = values.length);
				}
			}
