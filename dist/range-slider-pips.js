...
(function (global, factory) {
	...
	function get_each_context(ctx, list, i) {
		...
		const constants_0 = `z-index: ${/*activeHandle*/ child_ctx[35] === /*index*/ child_ctx[90]
	? 3
	: 2};`;

		child_ctx[87] = constants_0;
		const constants_1 = `${/*orientationStart*/ child_ctx[37]}: ${/*$springPositions*/ child_ctx[39][/*index*/ child_ctx[90]]}%;`;
	...
	function get_if_ctx(ctx) {
		...
		const constants_1 = /*handleFormatter*/ child_ctx[4](/*value*/ child_ctx[6], /*index*/ child_ctx[90], /*percent*/ child_ctx[91]);
	...
	function create_if_block_9(ctx) {
		...
		let html_tag;
		let raw_value = /*formattedValue*/ ctx[92] + "";
		let html_anchor;
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty[0] & /*handleFormatter, values, min, max, precision*/ 279 && raw_value !== (raw_value = /*formattedValue*/ ctx[92] + "")) html_tag.p(raw_value);
	...
	function create_each_block(ctx) {
		...
		return {
			c() {
				...
				attr(span1, "data-handle", /*index*/ ctx[90]);
				attr(span1, "style", span1_style_value = "" + (/*handlePos*/ ctx[88] + " " + /*zindex*/ ctx[87]));
				attr(span1, "aria-label", span1_aria_label_value = /*ariaLabels*/ ctx[5][/*index*/ ctx[90]]);

				attr(span1, "aria-valuemin", span1_aria_valuemin_value = /*range*/ ctx[9] === true && /*index*/ ctx[90] === 1
				? /*values*/ ctx[2][0]
				: /*min*/ ctx[0]);

				attr(span1, "aria-valuemax", span1_aria_valuemax_value = /*range*/ ctx[9] === true && /*index*/ ctx[90] === 0
				? /*values*/ ctx[2][1]
				: /*max*/ ctx[1]);

				attr(span1, "aria-valuenow", span1_aria_valuenow_value = /*value*/ ctx[6]);
				attr(span1, "aria-valuetext", span1_aria_valuetext_value = /*ariaLabelFormatter*/ ctx[53](/*value*/ ctx[6], /*index*/ ctx[90]));
				...
				toggle_class(span1, "rsActive", /*focus*/ ctx[32] && /*activeHandle*/ ctx[35] === /*index*/ ctx[90]);
				toggle_class(span1, "rsPress", /*handlePressed*/ ctx[33] && /*activeHandle*/ ctx[35] === /*index*/ ctx[90]);
			},
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						listen(span1, "blur", /*sliderBlurHandle*/ ctx[43]),
						listen(span1, "focus", /*sliderFocusHandle*/ ctx[44]),
						listen(span1, "keydown", /*sliderKeydown*/ ctx[45])
					];
			...
			p(ctx, dirty) {
				...
				if (dirty[1] & /*orientationStart, $springPositions, activeHandle*/ 336 && span1_style_value !== (span1_style_value = "" + (/*handlePos*/ ctx[88] + " " + /*zindex*/ ctx[87]))) {
					attr(span1, "style", span1_style_value);
				}

				if (dirty[0] & /*ariaLabels*/ 32 && span1_aria_label_value !== (span1_aria_label_value = /*ariaLabels*/ ctx[5][/*index*/ ctx[90]])) {
					attr(span1, "aria-label", span1_aria_label_value);
				}

				if (dirty[0] & /*range, values, min*/ 517 && span1_aria_valuemin_value !== (span1_aria_valuemin_value = /*range*/ ctx[9] === true && /*index*/ ctx[90] === 1
				? /*values*/ ctx[2][0]
				: /*min*/ ctx[0])) {
					attr(span1, "aria-valuemin", span1_aria_valuemin_value);
				}

				if (dirty[0] & /*range, values, max*/ 518 && span1_aria_valuemax_value !== (span1_aria_valuemax_value = /*range*/ ctx[9] === true && /*index*/ ctx[90] === 0
				? /*values*/ ctx[2][1]
				: /*max*/ ctx[1])) {
				...
				if (dirty[0] & /*values*/ 4 && span1_aria_valuetext_value !== (span1_aria_valuetext_value = /*ariaLabelFormatter*/ ctx[53](/*value*/ ctx[6], /*index*/ ctx[90]))) {
	...
	function create_if_block_8(ctx) {
		...
		return {
			c() {
				...
				attr(span, "style", span_style_value = "" + (/*orientationStart*/ ctx[37] + ": " + valueAsPercent(/*limits*/ ctx[18][0], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8]) + "%; " + /*orientationEnd*/ ctx[36] + ": " + (100 - valueAsPercent(/*limits*/ ctx[18][1], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8])) + "%;"));
			},
			m(target, anchor) {
				insert(target, span, anchor);
			},
			p(ctx, dirty) {
				if (dirty[0] & /*limits, min, max, precision*/ 262403 | dirty[1] & /*orientationStart, orientationEnd*/ 96 && span_style_value !== (span_style_value = "" + (/*orientationStart*/ ctx[37] + ": " + valueAsPercent(/*limits*/ ctx[18][0], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8]) + "%; " + /*orientationEnd*/ ctx[36] + ": " + (100 - valueAsPercent(/*limits*/ ctx[18][1], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8])) + "%;"))) {
					attr(span, "style", span_style_value);
				}
			},
			d(detaching) {
	...
	function create_if_block_1(ctx) {
		...
		return {
			c() {
				...
				attr(span, "style", span_style_value = "" + (/*orientationStart*/ ctx[37] + ": " + /*rangeStart*/ ctx[41](/*$springPositions*/ ctx[39]) + "%; " + /*orientationEnd*/ ctx[36] + ": " + /*rangeEnd*/ ctx[42](/*$springPositions*/ ctx[39]) + "%;"));
			...
			p(ctx, dirty) {
				...
				if (dirty[1] & /*orientationStart, $springPositions, orientationEnd*/ 352 && span_style_value !== (span_style_value = "" + (/*orientationStart*/ ctx[37] + ": " + /*rangeStart*/ ctx[41](/*$springPositions*/ ctx[39]) + "%; " + /*orientationEnd*/ ctx[36] + ": " + /*rangeEnd*/ ctx[42](/*$springPositions*/ ctx[39]) + "%;"))) {
					attr(span, "style", span_style_value);
				}
	...
	function create_else_block(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty[0] & /*reversed, values*/ 32772 && raw1_value !== (raw1_value = /*second*/ ctx[86] + "")) html_tag_1.p(raw1_value);
	...
	function create_if_block(ctx) {
		...
		rangepips = new RangePips({
				props: {
					...
					orientationStart: /*orientationStart*/ ctx[37],
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty[1] & /*orientationStart*/ 64) rangepips_changes.orientationStart = /*orientationStart*/ ctx[37];
	...
	function create_fragment(ctx) {
		...
		let if_block1 = /*hasRange*/ ctx[38] && create_if_block_1(ctx);
		...
		return {
			c() {
				...
				toggle_class(div, "rsRange", /*hasRange*/ ctx[38]);
				toggle_class(div, "rsDrag", /*hasRange*/ ctx[38] && /*draggy*/ ctx[10]);
				toggle_class(div, "rsMin", /*hasRange*/ ctx[38] && /*range*/ ctx[9] === 'min');
				toggle_class(div, "rsMax", /*hasRange*/ ctx[38] && /*range*/ ctx[9] === 'max');
			...
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						listen(window, "mousedown", /*bodyInteractStart*/ ctx[48]),
						listen(window, "touchstart", /*bodyInteractStart*/ ctx[48]),
						listen(window, "mousemove", /*bodyInteract*/ ctx[49]),
						listen(window, "touchmove", /*bodyInteract*/ ctx[49]),
						listen(window, "mouseup", /*bodyMouseUp*/ ctx[50]),
						listen(window, "touchend", /*bodyTouchEnd*/ ctx[51]),
						listen(window, "keydown", /*bodyKeyDown*/ ctx[52]),
						listen(div, "mousedown", /*sliderInteractStart*/ ctx[46]),
						listen(div, "mouseup", /*sliderInteractEnd*/ ctx[47]),
						listen(div, "touchstart", prevent_default(/*sliderInteractStart*/ ctx[46])),
						listen(div, "touchend", prevent_default(/*sliderInteractEnd*/ ctx[47]))
					];
			...
			p(ctx, dirty) {
				if (dirty[0] & /*ariaLabels, range, values, min, max, vertical, disabled, suffix, handleFormatter, precision, prefix, float*/ 50475831 | dirty[1] & /*orientationStart, $springPositions, activeHandle, ariaLabelFormatter, focus, handlePressed, sliderBlurHandle, sliderFocusHandle, sliderKeydown*/ 4223318) {
				...
				if (!current || dirty[0] & /*classes*/ 268435456 | dirty[1] & /*hasRange*/ 128) {
					toggle_class(div, "rsRange", /*hasRange*/ ctx[38]);
				}

				if (!current || dirty[0] & /*classes, draggy*/ 268436480 | dirty[1] & /*hasRange*/ 128) {
					toggle_class(div, "rsDrag", /*hasRange*/ ctx[38] && /*draggy*/ ctx[10]);
				}

				if (!current || dirty[0] & /*classes, range*/ 268435968 | dirty[1] & /*hasRange*/ 128) {
					toggle_class(div, "rsMin", /*hasRange*/ ctx[38] && /*range*/ ctx[9] === 'min');
				}
	...
	function instance($$self, $$props, $$invalidate) {
		...
		let $springPositions,
			...
			$$subscribe_springPositions = () => ($$unsubscribe_springPositions(), $$unsubscribe_springPositions = subscribe(springPositions, $$value => $$invalidate(39, $springPositions = $$value)), springPositions);
		...
		const checkValuesAgainstRangeGaps = () => {
			...
			if (rangeGapMin < 0) $$invalidate(54, rangeGapMin = 0);

			if (rangeGapMax < 0) $$invalidate(55, rangeGapMax = Infinity);

			// rangeGapMin must be less than rangeGapMax
			if (rangeGapMin > rangeGapMax) $$invalidate(54, rangeGapMin = rangeGapMax);
	 ...
	 **/
		...
		$$self.$$set = $$props => {
			...
			if ('pushy' in $$props) $$invalidate(56, pushy = $$props.pushy);
			...
			if ('springValues' in $$props) $$invalidate(57, springValues = $$props.springValues);
			if ('spring' in $$props) $$invalidate(58, spring$1 = $$props.spring);
		};
		...
		$$self.$$.update = () => {
			...
			if ($$self.$$.dirty[0] & /*values, min, max, step, precision, limits*/ 264455 | $$self.$$.dirty[1] & /*valueLength, springValues, springPositions, spring*/ 469762049) {
				{
					...
					$$invalidate(59, valueLength = values.length);
				}
			}
			...
			if ($$self.$$.dirty[0] & /*range, values*/ 516) {
				$$invalidate(38, hasRange = range === true && values.length === 2 || (range === 'min' || range === 'max') && values.length === 1);
			}
	 ...
	 **/
				$$invalidate(37, orientationStart = vertical
				? reversed ? 'top' : 'bottom'
				: reversed ? 'right' : 'left');
			}

			if ($$self.$$.dirty[0] & /*vertical, reversed*/ 36864) {
				$$invalidate(36, orientationEnd = vertical
				? reversed ? 'bottom' : 'top'
				: reversed ? 'left' : 'right');
			}
		};
