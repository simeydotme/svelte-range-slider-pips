...
function add_css$1(target) {
	append_styles(target, "svelte-1dg8xrq", ".rangePips{--pip:var(--range-pip, lightslategray);--pip-text:var(--range-pip-text, var(--pip));--pip-active:var(--range-pip-active, darkslategrey);--pip-active-text:var(--range-pip-active-text, var(--pip-active));--pip-hover:var(--range-pip-hover, darkslategrey);--pip-hover-text:var(--range-pip-hover-text, var(--pip-hover));--pip-in-range:var(--range-pip-in-range, var(--pip-active));--pip-in-range-text:var(--range-pip-in-range-text, var(--pip-active-text));--pip-out-of-limit:var(--range-pip-out-of-limit, #aebecf);--pip-out-of-limit-text:var(--range-pip-out-of-limit-text, var(--pip-out-of-limit))}.rangePips{position:absolute;height:1em;left:0;right:0;bottom:-1em;font-variant-numeric:tabular-nums}.rangePips.rsVertical{height:auto;width:1em;left:100%;right:auto;top:0;bottom:0}.rangePips .rsPip{height:0.4em;position:absolute;top:0.25em;width:1px;white-space:nowrap}.rangePips.rsVertical .rsPip{height:1px;width:0.4em;left:0.25em;top:auto;bottom:auto}.rangePips .rsPipVal{position:absolute;top:0.4em;transform:translate(-50%, 25%);display:inline-flex}.rangePips.rsVertical .rsPipVal{position:absolute;top:0;left:0.4em;transform:translate(25%, -50%)}.rangePips .rsPip{transition:all 0.15s ease}.rangePips .rsPipVal{transition:all 0.15s ease,\n      font-weight 0s linear}.rangePips .rsPip{color:lightslategray;color:var(--pip-text);background-color:lightslategray;background-color:var(--pip)}.rangePips .rsPip.rsSelected{color:darkslategrey;color:var(--pip-active-text);background-color:darkslategrey;background-color:var(--pip-active)}.rangePips.rsHoverable:not(.rsDisabled) .rsPip:not(.rsOutOfLimit):hover{color:darkslategrey;color:var(--pip-hover-text);background-color:darkslategrey;background-color:var(--pip-hover)}.rangePips .rsPip.rsInRange{color:darkslategrey;color:var(--pip-in-range-text);background-color:darkslategrey;background-color:var(--pip-in-range)}.rangePips .rsPip.rsOutOfLimit{color:#aebecf;color:var(--pip-out-of-limit-text);background-color:#aebecf;background-color:var(--pip-out-of-limit)}.rangePips .rsPip.rsSelected{height:0.75em}.rangePips.rsVertical .rsPip.rsSelected{height:1px;width:0.75em}.rangePips .rsPip.rsSelected .rsPipVal{font-weight:bold;top:0.75em}.rangePips.rsVertical .rsPip.rsSelected .rsPipVal{top:0;left:0.75em}.rangePips.rsHoverable:not(.rsDisabled) .rsPip:not(.rsSelected):not(.rsOutOfLimit):hover{transition:none}.rangePips.rsHoverable:not(.rsDisabled) .rsPip:not(.rsSelected):not(.rsOutOfLimit):hover .rsPipVal{transition:none;font-weight:bold}");
}
...
function add_css(target) {
	append_styles(target, "svelte-2cuia0", ".rangeSlider{--slider:var(--range-slider, #d7dada);--handle-inactive:var(--range-handle-inactive, #99a2a2);--handle:var(--range-handle, #838de7);--handle-focus:var(--range-handle-focus, #4a40d4);--handle-border:var(--range-handle-border, var(--handle));--range-inactive:var(--range-range-inactive, var(--handle-inactive));--range:var(--range-range, var(--handle-focus));--range-limit:var(--range-range-limit, #b9c2c2);--range-hover:var(--range-range-hover, var(--handle-border));--range-press:var(--range-range-press, var(--handle-border));--float-inactive:var(--range-float-inactive, var(--handle-inactive));--float:var(--range-float, var(--handle-focus));--float-text:var(--range-float-text, white)}.rangeSlider{position:relative;border-radius:100px;height:0.5em;margin:1em;transition:opacity 0.2s ease;user-select:none;overflow:visible}.rangeSlider *{user-select:none}.rangeSlider.rsPips{margin-bottom:1.8em}.rangeSlider.rsPipLabels{margin-bottom:2.8em}.rangeSlider.rsVertical{display:inline-block;border-radius:100px;width:0.5em;min-height:200px}.rangeSlider.rsVertical.rsPips{margin-right:1.8em;margin-bottom:1em}.rangeSlider.rsVertical.rsPipLabels{margin-right:2.8em;margin-bottom:1em}.rangeSlider .rangeHandle{position:absolute;display:block;height:1.4em;width:1.4em;top:0.25em;bottom:auto;transform:translateY(-50%) translateX(-50%);z-index:2}.rangeSlider.rsReversed .rangeHandle{transform:translateY(-50%) translateX(50%)}.rangeSlider.rsVertical .rangeHandle{left:0.25em;top:auto;transform:translateY(50%) translateX(-50%)}.rangeSlider.rsVertical.rsReversed .rangeHandle{transform:translateY(-50%) translateX(-50%)}.rangeSlider .rangeNub,.rangeSlider .rangeHandle:before{position:absolute;left:0;top:0;display:block;border-radius:10em;height:100%;width:100%;transition:box-shadow 0.2s ease}.rangeSlider .rangeHandle:before{content:'';left:1px;top:1px;bottom:1px;right:1px;height:auto;width:auto;box-shadow:0 0 0 0px var(--handle-border);opacity:0}.rangeSlider.rsHoverable:not(.rsDisabled) .rangeHandle:hover:before{box-shadow:0 0 0 8px var(--handle-border);opacity:0.2}.rangeSlider.rsHoverable:not(.rsDisabled) .rangeHandle.rsPress:before,.rangeSlider.rsHoverable:not(.rsDisabled) .rangeHandle.rsPress:hover:before{box-shadow:0 0 0 12px var(--handle-border);opacity:0.4}.rangeSlider.rsRange:not(.rsMin):not(.rsMax) .rangeNub{border-radius:10em 10em 10em 1.6em}.rangeSlider.rsRange .rangeHandle:nth-of-type(1) .rangeNub{transform:rotate(-135deg)}.rangeSlider.rsRange .rangeHandle:nth-of-type(2) .rangeNub{transform:rotate(45deg)}.rangeSlider.rsRange.rsReversed .rangeHandle:nth-of-type(1) .rangeNub{transform:rotate(45deg)}.rangeSlider.rsRange.rsReversed .rangeHandle:nth-of-type(2) .rangeNub{transform:rotate(-135deg)}.rangeSlider.rsRange.rsVertical .rangeHandle:nth-of-type(1) .rangeNub{transform:rotate(135deg)}.rangeSlider.rsRange.rsVertical .rangeHandle:nth-of-type(2) .rangeNub{transform:rotate(-45deg)}.rangeSlider.rsRange.rsVertical.rsReversed .rangeHandle:nth-of-type(1) .rangeNub{transform:rotate(-45deg)}.rangeSlider.rsRange.rsVertical.rsReversed .rangeHandle:nth-of-type(2) .rangeNub{transform:rotate(135deg)}.rangeSlider .rangeFloat{display:block;position:absolute;left:50%;bottom:1.75em;transform:translate(-50%, -50%);font-size:1em;text-align:center;opacity:0;pointer-events:none;white-space:nowrap;transition:all 0.2s ease;font-size:0.9em;padding:0.2em 0.4em;border-radius:0.2em;z-index:3}.rangeSlider .rangeHandle.rsActive .rangeFloat,.rangeSlider.rsHoverable .rangeHandle:hover .rangeFloat,.rangeSlider.rsHoverable .rangeBar:hover .rangeFloat,.rangeSlider.rsFocus .rangeBar .rangeFloat{opacity:1;transform:translate(-50%, 0%)}.rangeSlider .rangeBar .rangeFloat{bottom:0.875em;z-index:2}.rangeSlider.rsVertical .rangeFloat{top:50%;bottom:auto;left:auto;right:1.75em;transform:translate(-50%, -50%)}.rangeSlider.rsVertical .rangeHandle.rsActive .rangeFloat,.rangeSlider.rsVertical.rsHoverable .rangeHandle:hover .rangeFloat,.rangeSlider.rsVertical.rsHoverable .rangeBar:hover .rangeFloat,.rangeSlider.rsVertical.rsFocus .rangeBar .rangeFloat{transform:translate(0%, -50%)}.rangeSlider.rsVertical .rangeBar .rangeFloat{right:0.875em}.rangeSlider .rangeBar,.rangeSlider .rangeLimit,.rangeSlider.rsDrag .rangeBar::before{position:absolute;display:block;transition:background 0.2s ease;border-radius:1em;height:0.5em;top:0;user-select:none;z-index:1}.rangeSlider.rsVertical .rangeBar,.rangeSlider.rsVertical .rangeLimit,.rangeSlider.rsVertical.rsDrag .rangeBar::before{width:0.5em;height:auto}.rangeSlider.rsDrag .rangeBar::before{content:'';inset:0;top:-0.5em;bottom:-0.5em;height:auto;background-color:var(--range-hover);opacity:0;transition:opacity 0.2s ease,\n      scale 0.2s ease}.rangeSlider.rsVertical.rsDrag .rangeBar::before{inset:0;left:-0.5em;right:-0.5em;width:auto}.rangeSlider.rsHoverable:not(.rsDisabled).rsDrag .rangeBar:hover::before{opacity:0.2}.rangeSlider.rsHoverable:not(.rsDisabled).rsDrag .rangeBar.rsPress::before{opacity:0.4;scale:1 1.25}.rangeSlider.rsVertical.rsHoverable:not(.rsDisabled).rsDrag .rangeBar.rsPress::before{scale:1.25 1}.rangeSlider{background-color:#d7dada;background-color:var(--slider)}.rangeSlider .rangeBar{background-color:#99a2a2;background-color:var(--range-inactive)}.rangeSlider.rsFocus .rangeBar{background-color:#838de7;background-color:var(--range)}.rangeSlider .rangeLimit{background-color:#99a2a280;background-color:var(--range-limit)}.rangeSlider .rangeNub{background-color:#99a2a2;background-color:var(--handle-inactive)}.rangeSlider.rsFocus .rangeNub{background-color:#838de7;background-color:var(--handle)}.rangeSlider .rangeHandle.rsActive .rangeNub{background-color:#4a40d4;background-color:var(--handle-focus)}.rangeSlider .rangeFloat{color:white;color:var(--float-text);background-color:#99a2a2;background-color:var(--float-inactive)}.rangeSlider.rsFocus .rangeFloat{background-color:#4a40d4;background-color:var(--float)}.rangeSlider.rsDisabled{opacity:0.5}.rangeSlider.rsDisabled .rangeNub{background-color:#d7dada;background-color:var(--slider)}");
}
...
function get_each_context(ctx, list, i) {
	...
	const constants_0 = `z-index: ${/*activeHandle*/ child_ctx[34] === /*index*/ child_ctx[89]
	? 3
	: 2};`;

	child_ctx[86] = constants_0;
	const constants_1 = `${/*orientationStart*/ child_ctx[36]}: ${/*$springPositions*/ child_ctx[38][/*index*/ child_ctx[89]]}%;`;
...
function get_if_ctx(ctx) {
	...
	const constants_1 = /*handleFormatter*/ child_ctx[4](/*value*/ child_ctx[6], /*index*/ child_ctx[89], /*percent*/ child_ctx[90]);
...
function create_if_block_9(ctx) {
	...
	let html_tag;
	let raw_value = /*formattedValue*/ ctx[91] + "";
	let html_anchor;
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*handleFormatter, values, min, max, precision*/ 279 && raw_value !== (raw_value = /*formattedValue*/ ctx[91] + "")) html_tag.p(raw_value);
...
// (731:2) {#each values as value, index}
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			attr(span1, "data-handle", /*index*/ ctx[89]);
			attr(span1, "style", span1_style_value = "" + (/*handlePos*/ ctx[87] + " " + /*zindex*/ ctx[86]));
			attr(span1, "aria-label", span1_aria_label_value = /*ariaLabels*/ ctx[5][/*index*/ ctx[89]]);

			attr(span1, "aria-valuemin", span1_aria_valuemin_value = /*range*/ ctx[9] === true && /*index*/ ctx[89] === 1
			? /*values*/ ctx[2][0]
			: /*min*/ ctx[0]);

			attr(span1, "aria-valuemax", span1_aria_valuemax_value = /*range*/ ctx[9] === true && /*index*/ ctx[89] === 0
			? /*values*/ ctx[2][1]
			: /*max*/ ctx[1]);

			attr(span1, "aria-valuenow", span1_aria_valuenow_value = /*value*/ ctx[6]);
			attr(span1, "aria-valuetext", span1_aria_valuetext_value = /*ariaLabelFormatter*/ ctx[52](/*value*/ ctx[6], /*index*/ ctx[89]));
			...
			toggle_class(span1, "rsActive", /*focus*/ ctx[31] && /*activeHandle*/ ctx[34] === /*index*/ ctx[89]);
			toggle_class(span1, "rsPress", /*handlePressed*/ ctx[32] && /*activeHandle*/ ctx[34] === /*index*/ ctx[89]);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty[1] & /*orientationStart, $springPositions, activeHandle*/ 168 && span1_style_value !== (span1_style_value = "" + (/*handlePos*/ ctx[87] + " " + /*zindex*/ ctx[86]))) {
				attr(span1, "style", span1_style_value);
			}

			if (dirty[0] & /*ariaLabels*/ 32 && span1_aria_label_value !== (span1_aria_label_value = /*ariaLabels*/ ctx[5][/*index*/ ctx[89]])) {
				attr(span1, "aria-label", span1_aria_label_value);
			}

			if (dirty[0] & /*range, values, min*/ 517 && span1_aria_valuemin_value !== (span1_aria_valuemin_value = /*range*/ ctx[9] === true && /*index*/ ctx[89] === 1
			? /*values*/ ctx[2][0]
			: /*min*/ ctx[0])) {
				attr(span1, "aria-valuemin", span1_aria_valuemin_value);
			}

			if (dirty[0] & /*range, values, max*/ 518 && span1_aria_valuemax_value !== (span1_aria_valuemax_value = /*range*/ ctx[9] === true && /*index*/ ctx[89] === 0
			? /*values*/ ctx[2][1]
			: /*max*/ ctx[1])) {
			...
			if (dirty[0] & /*values*/ 4 && span1_aria_valuetext_value !== (span1_aria_valuetext_value = /*ariaLabelFormatter*/ ctx[52](/*value*/ ctx[6], /*index*/ ctx[89]))) {
...
function create_if_block_8(ctx) {
	...
	return {
		c() {
			...
			attr(span, "style", span_style_value = "" + (/*orientationStart*/ ctx[36] + ": " + valueAsPercent(/*limits*/ ctx[18][0], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8]) + "%; " + /*orientationEnd*/ ctx[35] + ": " + (100 - valueAsPercent(/*limits*/ ctx[18][1], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8])) + "%;"));
		},
		m(target, anchor) {
			insert(target, span, anchor);
		},
		p(ctx, dirty) {
			if (dirty[0] & /*limits, min, max, precision*/ 262403 | dirty[1] & /*orientationStart, orientationEnd*/ 48 && span_style_value !== (span_style_value = "" + (/*orientationStart*/ ctx[36] + ": " + valueAsPercent(/*limits*/ ctx[18][0], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8]) + "%; " + /*orientationEnd*/ ctx[35] + ": " + (100 - valueAsPercent(/*limits*/ ctx[18][1], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8])) + "%;"))) {
				attr(span, "style", span_style_value);
			}
		},
		d(detaching) {
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			toggle_class(span, "rsPress", /*rangePressed*/ ctx[33]);
		},
		m(target, anchor) {
			insert(target, span, anchor);
			if (if_block) if_block.m(span, null);
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*reversed, values*/ 32772 && raw0_value !== (raw0_value = /*first*/ ctx[29] + "")) html_tag.p(raw0_value);
			...
			if (dirty[0] & /*reversed, values*/ 32772 && raw1_value !== (raw1_value = /*second*/ ctx[85] + "")) html_tag_1.p(raw1_value);
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			toggle_class(div, "rsRange", /*hasRange*/ ctx[37]);
			toggle_class(div, "rsDrag", /*hasRange*/ ctx[37] && /*draggy*/ ctx[10]);
			toggle_class(div, "rsMin", /*hasRange*/ ctx[37] && /*range*/ ctx[9] === 'min');
			toggle_class(div, "rsMax", /*hasRange*/ ctx[37] && /*range*/ ctx[9] === 'max');
			...
			toggle_class(div, "rsFocus", /*focus*/ ctx[31]);
			toggle_class(div, "rsPips", /*pips*/ ctx[19]);
			toggle_class(div, "rsPipLabels", /*all*/ ctx[21] === 'label' || /*first*/ ctx[29] === 'label' || /*last*/ ctx[22] === 'label' || /*rest*/ ctx[23] === 'label');
		},
		m(target, anchor) {
			insert(target, div, anchor);
		...
		p(ctx, dirty) {
			if (dirty[0] & /*ariaLabels, range, values, min, max, vertical, disabled, suffix, handleFormatter, precision, prefix, float*/ 50475831 | dirty[1] & /*orientationStart, $springPositions, activeHandle, ariaLabelFormatter, focus, handlePressed, sliderBlurHandle, sliderFocusHandle, sliderKeydown*/ 2111659) {
			...
			if (!current || dirty[0] & /*classes, draggy*/ 268436480 | dirty[1] & /*hasRange*/ 64) {
				toggle_class(div, "rsDrag", /*hasRange*/ ctx[37] && /*draggy*/ ctx[10]);
			}

			if (!current || dirty[0] & /*classes, range*/ 268435968 | dirty[1] & /*hasRange*/ 64) {
				toggle_class(div, "rsMin", /*hasRange*/ ctx[37] && /*range*/ ctx[9] === 'min');
			}
			...
			if (!current || dirty[0] & /*classes, all, first, last, rest*/ 819986432) {
				toggle_class(div, "rsPipLabels", /*all*/ ctx[21] === 'label' || /*first*/ ctx[29] === 'label' || /*last*/ ctx[22] === 'label' || /*rest*/ ctx[23] === 'label');
			}
		},
		i(local) {
 ...
 **/
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*values, min, max, step, precision, limits, springPositions*/ 1074006279 | $$self.$$.dirty[1] & /*valueLength, springValues, spring*/ 234881024) {
			{
